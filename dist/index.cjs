"use strict"; /*! Cloudflare Kit v1.0.0 | MIT License | github.com/bhuvaneshcj/cloudflare-stack */
function O(s, t) {
    if (!t) return s;
...
exports.AuthError = P;
exports.CacheError = v;
exports.CloudflareKitError = p;
exports.ConfigError = A;
exports.DatabaseError = L;
exports.HttpError = E;
exports.PluginError = m;
exports.PluginRegistry = x;
exports.RateLimitError = w;
exports.ValidationError = k;
exports.composePlugins = ne;
exports.corsMiddleware = K;
exports.createApp = q;
exports.createAuth = F;
exports.createCache = J;
exports.createDatabase = _;
exports.createKVRateLimitStore = H;
exports.createLogger = N;
exports.createMemoryRateLimitStore = M;
exports.createPlugin = re;
exports.createQueue = z;
exports.createQueueConsumer = G;
exports.createRateLimiter = ee;
exports.createStorage = Q;
exports.definePlugin = te;
exports.errorResponse = y;
exports.globalRegistry = I;
exports.handleError = Y;
exports.isCloudflareKitError = S;
exports.isOperationalError = Z;
exports.jsonMiddleware = V;
exports.jsonResponse = b;
exports.rateLimit = W;
exports.redirectResponse = j;
exports.securityHeadersMiddleware = B;
exports.successResponse = U;
exports.validateRequest = X; //# sourceMappingURL=index.cjs.map
